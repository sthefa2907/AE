...
export default function Header() {
    return (<header id="MainHeader" className="MainHeader">
        <h1>Agroemprende</h1>
        <nav>
            <li>

                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-browser-plus"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M4 4m0 1a1 1 0 0 1 1 -1h14a1 1 0 0 1 1 1v14a1 1 0 0 1 -1 1h-14a1 1 0 0 1 -1 -1z" /><path d="M4 8h16" /><path d="M8 4v4" /><path d="M10 14h4" /><path d="M12 12v4" /></svg>
                <Link href="/empresarios/nuevosproyectos">
                    Nuevos Proyectos
                </Link>
            </li>
            <li>
                ...
                <Link href="/empresarios/solicitudes">
                    Solicitudes
                </Link>
            </li>
            <li>
            ...
            <li>
                ...
                <Link href="/empresarios/convocatorias">
                    Convocatorias
                </Link>
            </li>
            <li>
